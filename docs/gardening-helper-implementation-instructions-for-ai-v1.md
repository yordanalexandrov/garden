...
- shared DTO/enums
- validation setup
- MCP server bootstrap foundation from `gardening-helper-mcp-server-design-v1.md` Phase MCP-1:
...
Do not expose MCP business read tools or mutation tools as part of Phase 1 foundation work.
