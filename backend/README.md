...
The app currently exposes only unauthenticated `GET /api/v1/health`.
Phase 5 prepares authenticated Places/Plants route dependencies, but public Places/Plants behavior is still deferred to the next Phase 5 steps.
Storage, weather, push, AI provider adapters, frontend work, domain repositories, and domain workflows are deferred to later phases.
